                                              ...
                                              <tr>
                                                  <td>
                                                     <form class="pull-left" name="secret" method="post" action="transactions.php">
                                                      <a href="#" onclick="document.forms["secret"].submit();"><button style="background: transparent; border: none; outline: none;">'.$firstName.' '.$middleName.' '.$lastName.'</button>&nbsp&nbsp</a>
