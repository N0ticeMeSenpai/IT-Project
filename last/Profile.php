    ...
    if($stmt = mysqli_prepare($conn, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
                ...
                $name_of_firm = htmlspecialchars($row["name_of_firm"]);
                ...
                $name_of_spouse = htmlspecialchars($row["name_of_spouse"]);
            }
      ...
      <div class="col-xs-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">Client
              <form class="pull-right" name="loan" method="post" action="ClientLoan.php">
                <a href="#" class="text-white" onclick="document.forms['loan'].submit();">Add Loan</a>
          ...
          <div class="panel-body">
            ...
            <div class="profile__header">
                <div class="fz-25"><?php echo $first_name. ' '.$middle_name.' ' .$last_name; ?></div>
              <div class="fz-15"><strong>Employment: </strong><?php echo $employment ?></div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
          <h4 class="panel-title">Client info
            ...
            <table class="table profile__table">
              <tbody>
                ...
                <tr style="display: none;" id="<?php echo $row['loan_id']; ?>">
                  ...
                  <td data-target="employment"><?php echo $employment; ?></td>
                  ...
                  <td data-target="spouse"><?php echo $name_of_spouse; ?></td>
                  ...
                  <?php 
                        ...
                        include 'Include/connection.php';
                          ...
                          <th><strong>Co Borrower<?php echo " ".$count++?></strong></th>
                           <td>
                            <a href="co_profile.php?co_borrower_id=<?php echo $output["co_borrower_id"]?> "> <?php echo $name?></a>
                    <?php 
                      }
                  } ?></td></tr>
              </tbody>
