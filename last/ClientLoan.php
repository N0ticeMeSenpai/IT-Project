		...
		<div class="container2">
			...
			<div class="form-group">
                <form method="post" action="ClientLoanAction.php">
                       ...
                       <input type=hidden name="loan_id" value='<?php echo $id2?>'>
						...
						<table class="table" id="dynamic_field">
								...
								<td colspan="2">
									<h2>
										<div class="row">
											...
											<div class="col-lg-6">
												<a style="width:30%;" class="btn i-3 pull-right text-center" href="Profile.php?loan_id=<?php echo $id2?>">Back</a>
											</div>
										</div>
									</h2>
								<td>
                            ...
                            <tr>
				                <td colspan="2">
				                	...
				                	<input type="number" name="amount" value="<?php echo $rowAmount['requested_amount']?>" class="i-3 name_list" required/>
				                </td>
							</tr>
                            <tr>
				                <td colspan="2">
				            ...
				            <tr>
				                <td colspan="2">
				                	...
				                	<input type="text" name="interest" class="i-3 name_list" value='<?php echo $rowRates['interest']?>' required/></td>
							</tr>
                            <tr>
				                <td colspan="2">
				                <label>Service Handling Fee(%)</label>
				                <input type="text" name="shf" class="i-3 name_list" value='<?php echo $rowRates['service_handling_fee']?>' required/></td>
							</tr>
                            <tr>
                                <td colspan="2">
								...
								<h3 class="text-center">CO BORROWER PERSONAL 1 INFORMATION</h3>
							    	...
							    	<div class="row">
				                       <div class="col-sm-5">
										...
										<div class="col-sm-3">
										    <input type="text" pattern="\d*" minlength="11" maxlength="11" placeholder="Contact Number" class="i-3" name="co_contact_no_one" id="co_contact_no" >
										</div>
							    	</div>
				                </td>
							</tr>
								...
								<h3 class="text-center">CO BORROWER PERSONAL 2 INFORMATION</h3>
							    	...
							    	<div class="row">
				                       <div class="col-sm-5">
										...
										<div class="col-sm-3">
										    <input type="text" pattern="\d*" minlength="11" maxlength="11" class="i-3" placeholder="Contact Number" name="co_contact_no_two" id="co_contact_no" >
										</div>
							    	</div>
				                </td>
							</tr>
