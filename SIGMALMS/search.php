        ...
        <div class="w3-modal-content">
            <div class="w3-container p-5">
                ...
                <form class="text-center" method="POST" action="scheduleExcel.php">
                    ...
                    <option value="<?php echo $row4[1]," ",$row4[2]," ",$row4[3];?>"><?php echo $row4[1]," ",$row4[2]," ",$row4[3];?></option>

                    <?php endwhile;?>

                    </select>
                    <div class="py-3 ">
                        <input class="b-2" name="exportSchedule" type="submit" value="Export">
                    </div>
                </form>
