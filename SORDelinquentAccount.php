...
if(isset($_POST['searchSalaryAccount']))
{
    ...
    $query = "SELECT * FROM `sor_delinquent_account_sa` WHERE CONCAT(`id`, `account_name`, `outstanding_balance`, `remarks`) LIKE '%".$valueToSearchSalaryAccount."%'";
    $search_result_salary_account = filterTableSalaryAccount($query);
    
}
 else {
    $query = "SELECT * FROM `sor_delinquent_account_sa`";
    $search_result_salary_account = filterTableSalaryAccount($query);
}
...
if(isset($_POST['searchBusinessAccount']))
{
    ...
    // search in all table columns
    // using concat mysql function
    $query = "SELECT * FROM `sor_delinquent_account_ba` WHERE CONCAT(`id`, `account_name`, `outstanding_balance`, `remarks`) LIKE '%".$valueToSearchBusinessAccount."%'";
    $search_result_business_account = filterTableBusinessAccount($query);
    
}
 else {
    $query = "SELECT * FROM `sor_delinquent_account_ba`";
    $search_result_business_account = filterTableBusinessAccount($query);
}
        ...
        <div class="container">
            ...
            <form action="/action_page.php">
                <select name="cars">
                    ...
                    <option value="mercedes" selected>Delinquents Accounts</option>
            ...
            <form action="SORDelinquentAccount.php" method="post">
