        ...
        <?php
            if($resultCheck > 0){
                While ($row2 = mysqli_fetch_assoc($result1)){
                       $sql1 = "SELECT * FROM loan where client_id='".$row2['client_id']."' && loan_status!='Remove';";
      ...
      <form class="text-center" action="payment.php" method="post">
        ...
        <table class="table">
          ...
          <div class="row">
            ...
            <div class="row">
                <h2> RESTRUCTURED</h2>
            <div class="col-sm-4"><strong>Date Booked: <?php echo $row1['date_booked']; ?></strong></div>
                <div class="col-sm-4"><strong>Bi-Monthly Payment: <?php echo $row1['bi_monthly']; ?></strong></div>    
            <div class="col-sm-4">
              <span>
                <strong>Maturity Date:</strong>  <?php echo $row1['maturity_date']; ?>
              </span>
