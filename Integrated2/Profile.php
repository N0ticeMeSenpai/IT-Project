...
if(isset($_GET["client_id"]) && !empty(trim($_GET["client_id"]))){
    ...
    as business_address, present_address, contact_no, name_of_spouse FROM client 
    INNER JOIN occupation ON client.client_id = occupation.client_id
    INNER JOIN co_borrower on co_borrower.co_borrower_id = occupation.co_borrower_id
