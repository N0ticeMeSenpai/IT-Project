<?php
    ...
    WHERE client.loan_type = 'Salary' AND client.status = 'Legal'";
    ...
    inner join payment on loan.loan_id = payment.loan_id 
    inner join payment_info on payment.payment_id = payment_info.payment_id
    WHERE client.loan_type = 'Salary' AND client.status = 'Legal' LIMIT " . $this_page_first_result . "," .  $results_per_page;
    $result = mysqli_query($conn, $query);
