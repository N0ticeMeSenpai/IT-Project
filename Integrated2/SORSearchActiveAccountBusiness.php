...
<head>
    ...
    <title>Search Active Account</title>
...
<body>
    <div class="no-padding">
        ...
        <div class="container">
            ...
            <h2 class="p-5 text-center">List of Active Account</h2>
            ...
            <table class="table">
                ...
                <?php
                 echo searchActiveAccountBusiness();
                    ?>
            </table>
            <p><a href="SORActiveAccount.php" class="btn btn-primary">Back</a></p>
