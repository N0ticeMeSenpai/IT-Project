...
//edited due date
 $sql = "INSERT INTO `payment_info`(`payment_id`,other_income,remarks) VALUES ((SELECT MAX(payment_id) FROM (SELECT * FROM payment) AS `payment` where loan_id='$loan_id' && due_date=(SELECT MAX(due_date) from payment where loan_id='$loan_id')),$fee,'Income from legal fees');";
