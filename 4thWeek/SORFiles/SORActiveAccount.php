...
if(isset($_POST['searchSalaryAccount']))
{
    ...
    $query = "SELECT * FROM `SOR_Active_Account_sa` WHERE CONCAT(`id`, `account_name`, `outstanding_balance`, `remarks`) LIKE '%".$valueToSearchSalaryAccount."%'";
    $search_result_salary_account = filterTableSalaryAccount($query);
    
}
 else {
    $query = "SELECT * FROM `SOR_Active_Account_sa`";
    $search_result_salary_account = filterTableSalaryAccount($query);
}
...
if(isset($_POST['searchBusinessAccount']))
{
    ...
    // search in all table columns
    // using concat mysql function
    $query = "SELECT * FROM `SOR_Active_Account_ba` WHERE CONCAT(`id`, `account_name`, `outstanding_balance`, `remarks`) LIKE '%".$valueToSearchBusinessAccount."%'";
    $search_result_business_account = filterTableBusinessAccount($query);
    
}
 else {
    $query = "SELECT * FROM `SOR_Active_Account_ba`";
    $search_result_business_account = filterTableBusinessAccount($query);
}
...
<body>
    <div class="container-fluid no-padding">
        ...
        <div class="container">
            ...
            <form action="SORActiveAccount.php" method="post">
