...
<?php
    ...
    $sql = "SELECT * FROM client WHERE last_name LIKE '%$search%' || first_name LIKE '%$search%' || middle_name LIKE '%$search%' || concat(first_name,' ',middle_name,' ',last_name) LIKE '%$search%' && registered_status = 'Approved'";
    ...
    <div class="modal-content text-center" >
      ...
      <form class="text-center" action="payment.php" method="post">
        ...
        <table class="table">
          ...
          <div class="row">
            <div class="col-sm-4"><strong>Date Booked: </strong><?php echo $row1['date_booked']; ?></div>
            <div class="col-sm-4"><span><strong>Bi-Monthly Payment:</strong> <?php echo $row1['bi_monthly']; ?></span></div>
            <div class="col-sm-4">
              <span>
           ...
           <thead class="text-white">
            ...
            <div class="modal-content">
              <span class="pull-right close">&times;</span>
              <select id="size_select<?php echo $ctr?>">
                  <option>---------</option>
