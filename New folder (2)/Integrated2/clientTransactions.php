    ...
    <div class="container">
      <h2 class="p-5 text-center">Transactions Of Client</h2>
        <?php
                       ...
                       $sql1 = "SELECT * FROM client join loan on client.client_id = loan.client_id where client.client_id='".$client_id."';";
        ...
        <table class="table">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <p><strong> Name:</strong> <a href="Profile.php?client_id=<?php echo $row1["client_id"]?> "> 
