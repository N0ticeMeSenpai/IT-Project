...
if (!mysqli_query($conn,$sql1)) {
 ...
 $sql = "INSERT INTO `payment_info`(`payment_id`,`fines`,remarks) VALUES ((SELECT payment_id FROM (SELECT * FROM payment_info) AS `payment_info` WHERE check_no='$check'),ceiling($fine),'RC');";
