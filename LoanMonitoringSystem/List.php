 ...
 <html>  
      ...
      <body>  
        <nav id="myNavbar" class="navbar nav-color" role="navigation">
           ...
           <div class="container pad-1" style="padding-bottom: 54px;">
                <h3 align="center">List Of Client</h3>  
                <br />   
                     <table id="employee_data" class="table" >  
                          ...
                          include "Include/connection.php";
                             $query ="SELECT * from client 
                                ...
                                WHERE registered_status='Approved' AND loan_status!='Remove' group by loan.loan_id";  
                            ...
                            {         
                              ...
                              $sqlForRemain = "SELECT (loan_balance+COALESCE(SUM(fines),0)+COALESCE(SUM(interest),0)-COALESCE((SUM(amount_paid)),0)) as rb FROM payment JOIN payment_info ON payment_info.payment_id = payment.payment_id JOIN loan ON payment.loan_id=loan.loan_id WHERE status='updated' && payment.loan_id=$id";
                                 ...
                                 echo '
                                    ...
                                    echo '</td><td>
                                              <a href="#" data-role="edit" data-id='. $row['loan_id'] .'><button class="btn"><img src="img/editing.png" width="20px"></button>&nbsp&nbsp</a>';
                                    if($_SESSION['user']['em_position']=='Operations Manager'){
                                    
                                    echo '<a href="#" data-role="update" data-id='. $row['loan_id'] .'><button class="btn"><img src="img/update.png" width="20px">
                                    </button></a>';
                ...
                <button onclick="document.getElementById('id01').style.display='block'" class="reports">REPORTS</button>
