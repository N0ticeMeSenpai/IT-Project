...
$rowForLoan = mysqli_fetch_assoc(mysqli_query($conn,$sqlForID));
...
if($number > 0)
{
	...
	for($i=0; $i<$number; $i++)
	{
		if(trim($_POST["due"][$i] == ''))
		{
            ...
            $sql = "INSERT INTO payment(due_date,loan_id,date_modified) VALUES('".mysqli_real_escape_string($conn, $_POST["due"][$i])."',$loan_id,CURDATE())";
