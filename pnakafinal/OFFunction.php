                  ...
                  $output .=  '
                        <tr id='. $row['loan_id'] .'>  
                            ...
                            $query1="SELECT group_concat(remarks) as remarks from loan
                              ...
                              join payment_info on payment.payment_id = payment_info.payment_id
                              WHERE (maturity_date > (select curdate())) AND 
                              (loan.loan_type = 'Business' AND loan.delinquent_status = 'Active') group by loan.loan_id";
                              $row1 = mysqli_fetch_assoc(mysqli_query($conn,$query1));
                  ...
                  $output .=  '
                        <tr id='. $row['loan_id'] .'>  
                            ...
                            $query1="SELECT group_concat(remarks) as remarks from loan
                              ...
                              join payment_info on payment.payment_id = payment_info.payment_id
                              WHERE (maturity_date < (select curdate())) AND 
                              (loan.loan_type = 'Salary' AND loan.delinquent_status = 'Legal') group by loan.loan_id";
                              $row1 = mysqli_fetch_assoc(mysqli_query($conn,$query1));
                  ...
                  $output .=  '
                        <tr id='. $row['loan_id'] .'>  
                            ...
                            $query1="SELECT group_concat(remarks) as remarks from loan
                              ...
                              join payment_info on payment.payment_id = payment_info.payment_id
                              WHERE (maturity_date < (select curdate())) AND 
                              (loan.loan_type = 'Business' AND loan.delinquent_status = 'Legal') group by loan.loan_id";
                              $row1 = mysqli_fetch_assoc(mysqli_query($conn,$query1));
                  ...
                  $output .=  '
                        <tr id='. $row['loan_id'] .'>  
                            ...
                            $query1="SELECT group_concat(remarks) as remarks from loan
                              ...
                              join payment_info on payment.payment_id = payment_info.payment_id
                              WHERE (maturity_date < (select curdate())) AND 
                              (loan.loan_type = 'Salary' AND loan.delinquent_status = 'Inactive') group by loan.loan_id";
                              $row1 = mysqli_fetch_assoc(mysqli_query($conn,$query1));
                  ...
                  $output .=  '
                        <tr id='. $row['loan_id'] .'>  
                            ...
                            $query1="SELECT group_concat(remarks) as remarks from loan
                              ...
                              join payment_info on payment.payment_id = payment_info.payment_id
                              WHERE (maturity_date > (select curdate())) AND 
                              (loan.loan_type = 'Business' AND loan.delinquent_status = 'Inactive') group by loan.loan_id";
                              $row1 = mysqli_fetch_assoc(mysqli_query($conn,$query1));
