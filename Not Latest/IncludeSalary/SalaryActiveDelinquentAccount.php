<?php
    ...
    WHERE (maturity_date < (select curdate())) AND (loan.loan_type = 'Salary' AND loan.delinquent_status = 'Active') group by loan.loan_id";
    ...
    AND loan.delinquent_status = 'Active') group by loan.loan_id
