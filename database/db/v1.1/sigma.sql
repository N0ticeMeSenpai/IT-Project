...
CREATE TABLE `loan` (
  ...
  PRIMARY KEY (`loan_id`),
  KEY `fk_customer_id2_idx` (`customer_id`),
...
CREATE TABLE `payment` (
  ...
  CONSTRAINT `fk_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `loan` (`loan_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-02-26 21:15:15
