...
?>
 ...
 <html>  
      <head>  
           <title>List Of Active Delinquent Clients</title>  
          <meta charset="UTF-8">
      ...
      <body>  
        <nav id="myNavbar" class="navbar nav-color" role="navigation">
           ...
           <div class="container pad-1">
                <h3 align="center">List Of Active Delinquent Clients</h3>  
                <br />   
                     <table id="employee_data" class="table">  
                          ...
                          $conn = mysqli_connect('localhost' , 'root' ,'' ,'sigma');
                             $query ="SELECT * from client 
                                ...
                                WHERE registered_status='Approved'
                                AND (maturity_date <= (select curdate()) AND delinquent_status = 'Active') group by loan.loan_id;";  
